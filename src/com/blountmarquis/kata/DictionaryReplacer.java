...
public class DictionaryReplacer {
    ...
    public static String replaceText(String text, Map<String,String> dictionary) {
        if(text == null || dictionary == null) throw new IllegalArgumentException();
    ...
    private static String buildReplacedText(Map<String, String> dictionary, String[] words) {
        ...
        for (String word : words) {
            if(isKey(word)){
                ...
                else appendWordToOutPutText(sb, word);
            }
            else appendWordToOutPutText(sb, word);
        }
    ...
    private static void appendWordToOutPutText(StringBuilder sb, String s) {sb.append(s).append(" ");}
}
