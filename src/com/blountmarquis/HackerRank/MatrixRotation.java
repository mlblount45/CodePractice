...
public class MatrixRotation {
  ...
  private static Integer moveSouth(int[][] matrix, int layerRowStart, int layerRowEnd,
      int layerColStart, Integer last) {
    Integer temp = null;
  ...
  private static Integer moveEast(int[][] matrix, int layerColStart, int layerColEnd,
      int layerRowStart, Integer last) {
    Integer temp = null;
  ...
  private static Integer moveNorth(int[][] matrix, int layerRowStart, int layerRowEnd,
      int layerColStart, Integer last) {
    Integer temp = null;
    for (; layerRowStart >= layerRowEnd; layerRowStart--) {
      temp = matrix[layerRowStart][layerColStart];
  ...
  private static Integer moveWest(int[][] matrix, int layerColStart, int layerColEnd,
      int layerRowStart, Integer last) {
    Integer temp = null;
    for (; layerColStart >= layerColEnd; layerColStart--) {
      temp = matrix[layerRowStart][layerColStart];
