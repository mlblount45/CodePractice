...
public class ReverseShuffleMergeLexo {
    ...
    private static String getSpecialWord(char[] s, int[] reqCount) { //reqCount has 2x more than needed of each char
        //TODO implement
    ...
    private static boolean charIsNeededBasedOnOccurrenceReq(int[] reqCount, int[] seenCharCount, char s) {
