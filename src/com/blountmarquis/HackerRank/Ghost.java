...
public class Ghost {
    ...
    private static boolean isCaseOneValid(int a, int b) {return (a-b) % 3 == 0;}

    private static boolean isCaseTwoValid(int b, int c) {return (b+c) % 5 == 0;}

    private static boolean isCaseThreeValid(int a, int c) {return (a*c) % 4 == 0;}
