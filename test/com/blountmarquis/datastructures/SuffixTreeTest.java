...
public class SuffixTreeTest {
    ...
    public void whenSuffixOccursMultipleTimesInWord() throws Exception {
        assertSuffixIndices("mississippi", "is", new ArrayList<Integer>(){{add(1);add(4);}});
    }

    @Test
    public void whenSuffixOccursSingleTimeInWord() {
        assertSuffixIndices("mississippi", "sip", new ArrayList<Integer>(){{add(6);}});
    }

    @Test
    public void whenSuffixesOverlapInWord() {
        assertSuffixIndices("banana", "ana", new ArrayList<Integer>(){{add(1);add(3);}});
    }
